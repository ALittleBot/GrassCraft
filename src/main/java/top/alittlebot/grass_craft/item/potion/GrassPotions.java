...
public class GrassPotions {
    ...
    public static final String STRONG_GRASS_POISONING_POTION_ID = "strong_grass_poisoning_potion";
    ...
    public static final Holder<Potion> STRONG_GRASS_POISONING_POTION;
    ...
    static {
        ...
        GRASS_POISONING_POTION = POTIONS.register(GRASS_POISONING_POTION_ID, () -> new Potion(new MobEffectInstance(GrassEffects.GRASS_POISONING, 180 * 20, 0)));
        STRONG_GRASS_POISONING_POTION = POTIONS.register(STRONG_GRASS_POISONING_POTION_ID, () -> new Potion(new MobEffectInstance(GrassEffects.GRASS_POISONING, 180 * 20, 1)));
    }
}
