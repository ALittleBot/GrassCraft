...
import top.alittlebot.grass_craft.datagen.provider.loot.GrassEntityLootSubProvider;
...
public class GrassLootTableProvider extends LootTableProvider {
    public GrassLootTableProvider(PackOutput pOutput, CompletableFuture<HolderLookup.Provider> pRegistries) {
        super(pOutput, Set.of(), List.of(
                ...
                new LootTableProvider.SubProviderEntry(GrassEntityLootSubProvider::new, LootContextParamSets.ENTITY)
        ), pRegistries);
    }
